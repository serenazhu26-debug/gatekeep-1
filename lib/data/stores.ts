...
export const stores: Store[] = [
  ...
  // Sydney Stores
  { id: 'hmsyd',   name: 'H&M Sydney',       lat: -33.8688, lng: 151.2093, address: '188 Pitt St, Sydney NSW 2000',           type: 'chain',   dotColor: '#E50010' },
  { id: 'zarasyd', name: 'Zara Sydney',      lat: -33.8696, lng: 151.2088, address: '450 George St, Sydney NSW 2000',          type: 'chain',   dotColor: '#1a1a1a' },
  { id: 'gpsyd',   name: 'General Pants',    lat: -33.8715, lng: 151.2075, address: '500 George St, Sydney NSW 2000',          type: 'chain',   dotColor: '#FFD700' },
  { id: 'flsyd',   name: 'Foot Locker Syd',  lat: -33.8690, lng: 151.2090, address: '188 Pitt St, Sydney NSW 2000',           type: 'chain',   dotColor: '#003087' },
  { id: 'vinnies', name: 'Vinnies Sydney',   lat: -33.8785, lng: 151.2135, address: '223 Crown St, Darlinghurst NSW 2010',   type: 'thrift',  dotColor: '#0056b3' },
  ];
